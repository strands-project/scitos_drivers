...
void ScitosDrive::initialize()
{
  ...
  robot_->getMiraAuthority().subscribe<mira::robot::DriveStatus>("/robot/DriveStatus",
...
void ScitosDrive::motor_status_callback(mira::ChannelRead<mira::robot::DriveStatus> data)
{
  ...
  s.normal = data->value().bits.mode_normal;
  s.motor_stopped = data->value().bits.mode_forced_stopped;
  s.free_run = data->value().bits.mode_freerun;
  s.emergency_button_pressed = data->value().bits.emergency_stop_activated;
  s.bumper_pressed = data->value().bits.bumper_front_activated;
  s.bus_error = data->value().bits.bumper_rear_activated;
  s.stall_mode_flag = data->value().bits.error_stall_mode;
  s.internal_error_flag = data->value().bits.error_firmare;
